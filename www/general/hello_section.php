<section id='hello-cont' class='default-style'>
	<div class='left-cont'> 
		<span>Hello 
			<?php if($user !== null) echo "<strong id='userPreferedNameId' class='special-chars'>". $user->getPreferedName() ."</strong>"; ?>
		</span><br>
...
<script>
	...
	function onLogoutClick(e) {
		window.location.href = "http://post-o-quot.com/includes/logout.php";
	}
</script>